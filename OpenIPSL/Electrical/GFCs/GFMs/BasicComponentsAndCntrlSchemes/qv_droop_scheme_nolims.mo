within OpenIPSL.Electrical.GFCs.GFMs.BasicComponentsAndCntrlSchemes;
model qv_droop_scheme_nolims
  ...
  Modelica.Blocks.Sources.Constant Qlimsig(k=0) "Reactive power limiter signal"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-30,-90})));
  low_pass_filter Qfilt(Tr=Tr, y0val=Q0)
  ...
  low_pass_filter Vfilt(Tr=Tr, y0val=V0) "Filtered voltage measurement"
